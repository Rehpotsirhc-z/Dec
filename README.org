...
** Arch Linux
If you are on Arch Linux, Dec is available in the [[https://aur.archlinux.org/packages/dec][AUR]]. Simply clone the repository and then run ~makepkg -si~ or install it using an AUR helper like paru.
